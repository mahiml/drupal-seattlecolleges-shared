...
function makeNiceTitles() {
    ...
    for (var ti = 0; ti < document.links.length; ti++) {
        ...
        if (lnk.title) {
        	if (lnk.href == 'https://northseattle.edu/'
        		|| lnk.href == 'https://northseattle.edu/schedule'
        		|| lnk.href == 'https://northseattle.edu/locator'
        		|| lnk.href == 'https://people.northseattle.edu/'
        		|| lnk.href == 'https://northseattle.edu/admissions/steps'
        		|| lnk.href == 'https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=LDXT6RLBVX6P6'
        		|| lnk.href == 'http://northscc.bkstore.com/'
        	) { continue; }		// NSCC MOD: Skip specific NSCC site navigation
