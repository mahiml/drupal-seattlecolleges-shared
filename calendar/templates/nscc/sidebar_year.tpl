...
<table width="170" border="0" cellpadding="0" cellspacing="0" class="calborder">
	...
	<tr>
		<td colspan="3" bgcolor="#FFFFFF" align="left">
			<div style="padding: 5px;"><!-- yr legend -->
				{L_LEGEND}:<br />
				{LEGEND}
...
<div class="subscribable-note">
	<p>Calendars are also available in several types of <a class="psf" href="/rss/index.php?cal={CAL}&amp;getdate={GETDATE}">subscribable formats</a></p>
</div>
