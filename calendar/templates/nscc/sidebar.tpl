...
<div class="subscribable-note">
	<p>These calendars are also available in several types of <a class="psf" href="{BASE}rss/index.php?cal={CAL}&amp;getdate={GETDATE}">subscribable formats</a></p>
</div>
<div class="subscribable-note">
	<p><a class="psf" href="http://seattlecolleges.edu/district/calendar/calendar2016-17.aspx">2016-17 Academic Calendar</a></p>
</div>
