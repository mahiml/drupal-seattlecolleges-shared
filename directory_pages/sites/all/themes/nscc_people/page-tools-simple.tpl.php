...
<div id="container">
	...
	<!-- Global Nav -->	
	<div id="navigation"><?php print $global_navigation; ?></div>
	...
	<div class="container-12 content-area">
		...
		<div id="main-column" class="grid-9">
			...
			<?php if ($left || $tools_sidebar): ?>
				<!-- Left Sidebar Wrapper -->
				<div class="grid-2 alpha">
					<?php if ($tools_sidebar): ?>
						<!-- Tools Sidebar -->
						<div id="tools-sidebar" class="region region-tools-sidebar">
							<?php print $tools_sidebar; ?>
						</div>
					<?php endif; ?>
					<?php if ($left): ?>
						<!-- Left Sidebar -->
						<div id="side-nav" class="region region-left grid-2 alpha">
							<?php print $left; ?>
						</div>
					<?php endif; ?>
				</div>
			...
			<div class="region region-main grid-7 omega">
		...
		<!-- Sidebar -->
		<div id="side-column1" class="region region-right grid-3"><?php print $right; ?></div>
