 ...
 */
function nscc_960_breadcrumb($breadcrumb) {
 ...
 */
function nscc_960_node_submitted($node) {
 ...
 */
function nscc_960_comment_submitted($comment) {
  return t('@datetime - !username',
    array(
 ...
 */
function nscc_960_menu_local_tasks() {
  $output = '';
 ...
 */
function nscc_960_menu_local_task($link, $active = FALSE) {
 ...
 */
function nscc_960_preprocess_search_block_form(&$variables) {
 ...
 * @see page.tpl.php
 */
function nscc_960_preprocess_page(&$variables) {
	$node = $variables['node'];
 ...
 */
function nscc_960_preprocess_node(&$variables) {
  $node = $variables['node'];
 ...
 */
function nscc_960_preprocess_block(&$variables) {
 ...
 */
function nscc_960_preprocess_content_field(&$variables) {
 ...
 */
function nscc_960_filefield_file($file) {
 ...
 */
function nscc_960_username($object) {
	...
	if(check_url($url)){
		switch($embed_type){
			case 'subscribe_link':
					...
					break;
			case 'agenda_embed':
					if( preg_match('/^https?:\/\/www.google.com\/calendar\/ical\/(northseattle\.edu_.+group\.calendar\.google\.com)\/public\/basic\.ics$/',$url,$matches) ){
