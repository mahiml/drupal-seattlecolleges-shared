...
<body class="<?php print $body_classes; ?>">
    ...
    <div id="header" class="region region-header">
      <div id="logo">
        <a href="https://northseattle.edu" title="North Seattle College">
          <img src="<?php print base_path().path_to_theme().'/imgs/aug2014/logo-main.png'; ?>" alt="North Seattle College" />
        </a>
      </div>
    <?php print $header; ?>
    </div>
  ...
  <?php endif; ?>
    ...
    <div class="container-12 sidenav-section content-area">
    <?php if ($left): ?>
    ...
    <?php endif; ?>
      <div class="grid-9">
      <?php if ($title_banner): ?>
        <div id="photo-header" class="grid-9 alpha omega">
          <?php print $title_banner; ?>
        </div>
        <div class="clearfix">&nbsp;</div>
      <?php endif; ?>
         <div id="main-column" class="grid-6 alpha">
        ...
        <div id="side-column1" class="region region-right grid-3 omega">
          <?php print $right; ?>
        </div>
      </div>
      <div class="clearfix">&nbsp;</div>
