...
/**
 * @file block-nscc_isp_admission-2.tpl.php
 *
 * Theme implementation to display the Ask-an-Advisor block (see ISP module).
 *
 * Available variables:
...
<div id="block-<?php print $block->module . '-' . $block->delta; ?>" class="<?php print $classes; ?>">
	<a href="/contact" class="ask-an-advisor-link">
