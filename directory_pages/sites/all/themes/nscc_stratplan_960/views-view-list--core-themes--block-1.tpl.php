...
/**
 * @file views-view-list--core-themes--block-1.tpl.php
 ...
 */
?>
<div class="item-list core-themes-menu-list block-menu">
  <?php if (!empty($title)) : ?>
    <h3><?php print $title; ?></h3>
  <?php endif; ?>
  <<?php print $options['type']; ?> class="menu">
    <?php foreach ($rows as $id => $row): ?>
      <li class="core-theme-menu-item <?php print $classes[$id]; ?>"><?php print $row; ?></li>
    <?php endforeach; ?>
