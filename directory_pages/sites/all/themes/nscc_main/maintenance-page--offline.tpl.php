...
<head>
  <!-- Uncomment the first line beneath this one to set northseattle.edu to go to the emergency site -->
  <!-- Site will only redirect if an error condition occures on the main site -->
  <meta http-equiv="refresh" content="0; url=http://webshares.northseattle.edu/main/" />
...
<body class="<?php print $body_classes; ?>">
  ...
  <?php endif; ?>
    ...
    <?php if ($left && $right): ?>
      <div id="main-column" class="grid-6 push-3">
    <?php elseif (! ($left || $right)): ?>
      <div id="main-column" class="grid-12">
    <?php elseif ($left): ?>
    	<div id="main-column" class="grid-9 push-3">
    <?php else: ?>
    ...
    <?php if ($left): ?>
    	<?php if($right): ?>
				<div id="side-nav" class="region region-left grid-3 pull-6">
      <?php else: ?>
				<div id="side-nav" class="region region-left grid-3 pull-9">
      <?php endif; ?>
        <?php print $left; ?>
      </div>
    <?php endif; ?>
