...
/**
 * @file block-newsletter-subscribe.tpl.php
 *
 * Theme implementation to display the ContEd email newsletter subscription form block.
 *
 * Available variables:
...
?>
<!-- Email Newsletter -->
<div id="block-newsletter-subscription" class="<?php print $classes; ?>">
