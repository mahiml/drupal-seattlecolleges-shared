...
<body class="<?php print $body_classes; ?>">
  ...
  <?php endif; ?>
    ...
    <?php endif; ?>
      <div class="grid-9">
      <?php if ($division_banner): ?>
        <div id="photo-header-program" class="grid-9 alpha omega">
          <?php print $division_banner; ?>
        </div>
      <?php endif; ?>
      <?php if ($right && $division_meta): ?>
        <div id="main-column" class="grid-5 alpha">
      <?php elseif ( !($right || $divsion_meta)): ?>
