...
<body class="<?php print $body_classes; ?> page-program-calendar">
  <div id="container">
  ...
  <?php endif; ?>
  	<!-- Program Calendar Page Content -->
    <div class="container-12 sidenav-program">
    <?php if ($left || $program_menu): ?>
    ...
    <?php endif; ?>
      <div class="grid-9">
      <?php if ($program_banner): ?>
        <div id="photo-header-program" class="grid-9 alpha omega">
          <?php print $program_banner; ?>
        </div>
        <div class="clearfix">&nbsp;</div>
      <?php endif; ?>
      <?php if ($right && $program_meta): ?>
        <div id="main-column" class="grid-5 alpha">
      <?php elseif ( !($right || $program_meta)): ?>
        <div id="main-column" class="grid-9 alpha omega">
      <?php else: ?>
        <div id="main-column" class="grid-7 alpha">
      <?php endif; ?>
        ...
        <?php endif; ?>
          ...
          <?php endif; ?>
          <?php if ($content_banner_before): ?>
            <div class="content_banner">
              <?php print $content_banner_before; ?>
            </div>
          <?php endif; ?>
          <?php if ($title || $feed_icons): ?>
            <div id="content-title">
            <?php if ($title): ?>
              <?php if ($content_banner_behind): ?>
              <div class="title-wrapper"<?php print $content_banner_behind['wrapper_attr']; ?>>
                <h1<?php print $content_banner_behind['title_attr']; ?>><?php print $title; ?></h1>
              </div>
              <?php elseif ($content_banner_instead): ?>
              <h1<?php print $content_banner_instead['h1_attr']; ?>><span<?php print $content_banner_instead['span_attr']; ?>></span><?php print $title; ?></h1>
              <?php else: ?>
            ...
            <?php endif; ?>
            <?php if ($content_banner_after): ?>
              <div class="content_banner">
                <?php print $content_banner_after; ?>
              </div>
            <?php endif; ?>
            </div>
          <?php endif; ?>
          ...
          <?php endif; ?>
          <?php if ($content_banner_bottom): ?>
            <div class="content_banner">
              <?php print $content_banner_bottom; ?>
            </div>
          <?php endif; ?>
          </div>
      ...
      <?php if($right && $program_meta): ?>
        <div id="side-column1" class="region region-right grid-2">
          <?php print $right; ?>
        </div>
      <?php elseif ($right && ! $program_meta): ?>
        <div id="side-column1" class="region region-right grid-2 omega">
          <?php print $right; ?>
        </div>
      <?php endif; ?>
      <?php if ($program_meta): ?>
        <div id="program-meta" class="grid-2 omega">
          <?php print $program_meta; ?>
        </div>
      <?php endif; ?>
      </div>
      <div class="clearfix">&nbsp;</div>
