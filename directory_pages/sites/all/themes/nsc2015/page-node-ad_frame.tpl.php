...
<body class="<?php print $body_classes; ?>">
  <div id="container">
    <div id="header" class="region region-header">
      <div id="logo">
        <a href="http://www.northseattle.edu/" title="College Homepage">
  ...
  <?php endif; ?>
    ...
    <div class="container-12 content-area">
			...
			<!-- Primary Ad Frame Content -->
			<div id="primary-content" class="grid-6 push-3">
				<?php print $first_callout; ?>
				<?php print $last_callout; ?>
				<div class="clearfix">&nbsp;</div>
				<div id="main-column" class="grid-6 alpha omega">
			...
			<!-- Secondary Content -->
			<div id="secondary-content" class="grid-3 pull-6">
			<?php if ($featured_promos): ?>
				<div class="region region-featured-promos">
			...
			<div id="supplimental-content" class="grid-3">
				<?php print $related_links; ?>
				<?php print $feed; ?>
				<?php print $testimonial; ?>
			<?php if ($contact_box): ?>
				<div class="contact-info">
				<?php print $contact_box; ?>
				</div>
			<?php endif; ?>
			</div>
      <div class="clearfix">&nbsp;</div>
