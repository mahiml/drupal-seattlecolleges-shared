...
<body class="<?php print $body_classes; ?>">
  <div id="container">
    <div id="header" class="region region-header">
      <div id="logo">
        <a href="https://northseattle.edu/" title="College Homepage">
...
<!--[if lt IE 7]><p class="chromeframe">Your browser is <em>ancient!</em> For a better online experience, you should <a href="http://browsehappy.com/">upgrade to a different browser</a> or <a href="http://www.google.com/chromeframe/?redirect=true">install Google Chrome Frame</a>.</p><![endif]-->
