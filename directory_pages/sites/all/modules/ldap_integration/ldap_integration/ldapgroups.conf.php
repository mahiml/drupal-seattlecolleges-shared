...
function ldapgroups_role_mappings() {
  return array(
    ...
    //'ou=admindom,dc=instructdom,dc=northseattle,dc=edu'=>'admin_account',
	'cn=websites_admins,ou=Groups,ou=admindom,dc=instructdom,dc=northseattle,dc=edu'=>'websites_admins'
