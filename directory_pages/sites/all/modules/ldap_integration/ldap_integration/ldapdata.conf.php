...
function ldapdata_attributes() {
  return array(
    'gecos' => array('text', 'textfield', t('Full Name'), 64, 64),
    'SID' => array('text', 'textfield', t('SID'), 64, 64),   
    'department' => array('text', 'textfield', t('Department'), 64, 64),   
    'telephoneNumber' => array('text', 'textfield', t('Telephone Number'), 64, 64),   
    'officeLocation' => array('text', 'textfield', t('Office'), 64, 64),   
    'wifiAccessGroup' => array('text', 'textfield', t('Wifi Access Group'), 64, 64),   
    'exchangeUname' => array('text', 'textfield', t('Exchange User Name'), 64, 64),   
