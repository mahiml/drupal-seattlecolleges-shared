<?php
// $Id: nscc_profile-wrapper.tpl.php,v 1.2 2007/08/07 08:39:35 goba Exp $

/**
 * @file nscc_profile-wrapper.tpl.php
 ...
 *   is also based on this, e.g., "nscc_profile-wrapper-last_name.tpl.php".
 *
 * @see template_preprocess_nscc_profile_wrapper()
 */
?>
<div id="nscc-profiles">
  <?php print $content; ?>
</div>
