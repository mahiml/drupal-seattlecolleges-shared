...
<div id="container">
  ...
  <?php endif; ?>
    <div id="masthead-photo">
      <a href="<?php print $front_page; ?>" title="People directory index">
        <img src="<?php print $base_path . $directory; ?>/imgs/cafegrads.jpg" alt="Graduates in regalia preparing for commencement">
      </a>
      <p class="photo-attribution" title="photo attribution">
        Photo ©2008 <a href="http://www.flickr.com/photos/djwudi/">Michael Hanscom</a>
      </p>
    </div>
  <?php if ($mission): ?>
  <div id="site-mission">
  ...
  <?php if ($breadcrumb): ?>
    <div class="breadcrumb region region-quicklinks">
  ...
  <div id="content-regions">
    <div id="primary-content-group" class="column">    
      ...
      <?php if ($tabs || $help || $messages): ?>
        ...
        <?php print $messages; ?>
        <?php if ($profile_tabs): ?>
          <div class="tabs"><?php print $profile_tabs; ?></div>
        <?php endif; ?>
        <?php if ($tabs): ?>
