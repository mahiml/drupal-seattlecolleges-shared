...
class DeleteURLConfigurationForm extends ConfigFormBase
{
    ...
    public function submitForm(array &$form, FormStateInterface $form_state) {
        ...
        $this->config('newscenter_rest_services.settings')->set('maritime_host_url', $form_state->getValue('maritime_host_url'))->save();
        $this->config('newscenter_rest_services.settings')->set('it_host_url', $form_state->getValue('it_host_url'))->save();
        $this->config('newscenter_rest_services.settings')->set('btm_host_url', $form_state->getValue('btm_host_url'))->save();
        $this->config('newscenter_rest_services.settings')->set('culinary_host_url', $form_state->getValue('culinary_host_url'))->save();
        $this->config('newscenter_rest_services.settings')->set('foundation_host_url', $form_state->getValue('foundation_host_url'))->save();
