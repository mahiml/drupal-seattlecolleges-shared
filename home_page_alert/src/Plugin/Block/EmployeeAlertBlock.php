 ...
 *
 * @Block(
 * id = "employeeAlertBlock",
 * admin_label = @Translation("Employee Alert Block"),
 * )
 */
class EmployeeAlertBlock extends BlockBase
{
    ...
    public function build()
    {
        ...
        $build['home_page_alert'] = array(
            '#lazy_builder' => ['home_alert_service:ShowEmployeeAlert', array()],
