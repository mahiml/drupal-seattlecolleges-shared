 ...
 *
 * @Block(
 * id = "communityAlertBlock",
 * admin_label = @Translation("Community  Alert Block"),
 * )
 */
class CommunityAlertBlock extends BlockBase
{
    ...
    public function build()
    {
        ...
        $build['home_page_alert'] = array(
            '#lazy_builder' => ['home_alert_service:ShowCommunityAlert', array()],
